...
public class Transaction implements Serializable {
    ...
    @OneToMany(mappedBy = "idTransaction",fetch = FetchType.LAZY)
    @JsonIgnore
    ...
    public boolean equals(Object object) {
        ...
        return (this.idTransaction != null || other.idTransaction == null) && (this.idTransaction == null || this.idTransaction.equals(other.idTransaction));
    }
